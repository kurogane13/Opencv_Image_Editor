                                ...
                                while(loop==2):
                                    ...
                                    try:
                                        ...
                                        if percentage > 100:
                                            ...
                                            wait_time = 1000
                                            while cv2.getWindowProperty("Resized image", cv2.WND_PROP_VISIBLE) >= 1:
                                    ...
                                    while(loop==8):                                
                                        ...
                                        try:
                                            ...
                                            if Height < 2:
                                                ...
                                                img = cv2.imread(item)
                                                dimensions = img.shape
                                                width = img.shape[0] # keep original height
                                                dim = (width, height)
                                                ...
                                                print(lines)
                                                height_difference = height-Height
